...
public class FornecedoresDAO {
	...
	public static void main(String[] args) {
		  ...
		  /*Fornecedores f1 = new Fornecedores(); f1.setDescricao("DESCRICAO TESTE");
		  
		  Fornecedores f2 = new Fornecedores();
		  f2.setDescricao("SEGUNDA DESCRICAO TESTE");
		 ...
		 System.out.println("ERRO AO INSERIR!!!"); e.printStackTrace(); }
		 */
		 ...
		 /* Fornecedores f1 = new Fornecedores(); f1.setCodigo(3);
		  ...
		  /*System.out.println("Erro ao excluir !!!"); e.printStackTrace(); }
		 
		 /*
		 * Fornecedores f1 = new Fornecedores(); f1.setCodigo(2);
		 * f1.setDescricao("TEXTO SENDO EDITADO");
		 * 
		 * FornecedoresDAO fdao = new FornecedoresDAO();
		 * 
		 * try { fdao.editar(f1); System.out.println("Editado com sucesso !!!"); } catch
		 * (SQLException ex) { System.out.println("Erro ao editar !!!");
		 * ex.printStackTrace(); }
		 *
		 * 
		 */ 
		...
		/*Fornecedores f1 = new Fornecedores(); f1.setCodigo(2);
		 ...
		 Fornecedores f2 = new Fornecedores(); f2.setCodigo(6);
		  ...
		  + f4); } catch (SQLException ex) {
		  System.out.println("Erro na busca, codigo inexistente !!!");
		  ex.printStackTrace();
